...
class vDataFile
{
  ...
  public:
    ...
    */
    ...
    /*!
    \fn      vDataFile::InitAdditionalData
    \param   a_pathToAdditionalData: path to additional data
    \brief   Memory allocation and initialization for the additional data matrices
    \details Nothing is performed if the path provided in parameter is empty; the data is directly read
    \return  0 if success, positive value otherwise
    */
    int InitAdditionalData(const vector<string>& a_pathToAdditionalData, vDataFile** ap_DataFile);
    /*!
      \fn      vDataFile::DeallocateAdditionalData
      \brief   Free memory for the additional data
    */
    void DeallocateAdditionalData();
    /*!
      \fn      vDataFile::IsLoadedAdditional
      \return  boolean indicating if one or several additional data have been loaded (true) or not (false)    */
    inline bool IsLoadedAdditional()
           {return m_loadedAdditional;}
    /*!
      \fn      public inline int vDataFile::GetNbAdditionalData()
      \brief   Get the number of additional data
      \return  m_nbAdditionalData
    */
    inline int GetNbAdditionalData()
           {return m_nbAdditionalData;}
    /*!
      \fn      public inline void vDataFile::SetNbAdditionalData()
      \param   int a_nbAdditionalData
      \brief   Set the number of additional data
    */
    inline void SetNbAdditionalData(int a_nbAdditionalData)
           {m_nbAdditionalData = a_nbAdditionalData;}
    /*!
      \fn      public inline INTNB vDataFile::GetSinogramSize()
      \brief   Get the total number of voxels in sinogram
      \return  m_sinogramSize
    */
    inline INTNB GetSinogramSize()
           {return m_sinogramSize;}
    /*!
      \fn      public inline void vDataFile::SetSinogramSize()
      \param   INTNB a_sinogramSize
      \brief   Set the total number of voxels in sinogram
    */
    inline void SetSinogramSize(INTNB a_sinogramSize)
           {m_sinogramSize = a_sinogramSize;}
  // -------------------------------------------------------------------
  ...
  // Data members
  public:
    FLTNB**     m2p_additionalData; /*!< Dynamic array for additional data to be used in reconstruction, containing a 2-vectors voxellized image matrix.
                                        2 pointers:
  ...
  protected:
    ...
    bool m_loadedAdditional;                  /*!< Flag indicating if additional data have been loaded */
    int m_nbAdditionalData;                   /*!< The number of additional data */
    INTNB m_sinogramSize;                     /*!< The size of sinogram in additional data */
};
#endif
