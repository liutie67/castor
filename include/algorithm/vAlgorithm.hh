...
class vAlgorithm
{
  ...
  public:
    ...
    */
    ...
    /*!
      \fn inline public oIterativeAlgorithm::SetPathToAdditionalData
      \param a_pathToAdditionalData
      \brief Set path to additional data
    */
    inline void SetPathToAdditionalData(vector<string> a_pathToAdditionalData)
           {m_pathToAdditionalData = a_pathToAdditionalData;}
    /*!
  ...
  protected:
    ...
    vector<string> m_pathToAdditionalData;              /*!< String vector containing paths to additional data */
