...
*/
class iOptimizerADMMLim_adaptiveRhoTau : public vOptimizer
{
  // -------------------------------------------------------------------
  ...
  public:
    ...
    */
    iOptimizerADMMLim_adaptiveRhoTau();
    /*!
      \fn      public iOptimizerADMMLim::~iOptimizerADMMLim()
  ...
  public:
    ...
    FUNCTION_OPTIMIZER(iOptimizerADMMLim_adaptiveRhoTau)
    /*!
...
CLASS_OPTIMIZER(ADMMLim_adaptiveRhoTau,iOptimizerADMMLim_adaptiveRhoTau)
