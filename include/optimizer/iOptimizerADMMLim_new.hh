...
*/
class iOptimizerADMMLim_new : public vOptimizer
{
  // -------------------------------------------------------------------
  ...
  public:
    ...
    FUNCTION_OPTIMIZER(iOptimizerADMMLim_new)
    /*!
...
CLASS_OPTIMIZER(ADMMLim_new,iOptimizerADMMLim_new)
