...
class vOptimizer
{
  ...
  public:
    ...
    */
    ...
    /*!
      \fn      public inline void vOptimizer::SetDataFile()
      \param   vDataFile* ap_DataFile
      \brief   Set the data file in use
    */
    ...
    */
    ...
    /*!
      \fn      public inline void vOptimizer::EnterPreProcessLoop()
      \brief   Set pre-process flag to true
    */
    inline void EnterPreProcessLoop()
           {m_isInPreProcessLoop = true;}
    /*!
      \fn      public inline void vOptimizer::ExitPreProcessLoop()
      \brief   Set pre-process flag to false
    */
    ...
    */
    inline void EnterPostProcessLoop()
           {m_isInPostProcessLoop = true;}
    /*!
      \fn      public inline void vOptimizer::ExitPostProcessLoop()
      \brief   Set post-process flag to false
    */
    ...
    */
    ...
    /*!
      ...
      \return  m_needPreProcessLoop
    */
    inline bool NeedPreProcessLoop()
           {return m_needPreProcessLoop;}
    /*!
      \fn      public inline bool vOptimizer::NeedPostProcessLoop()
      \brief   Say if the optimizer needs a post-process loop after iterations are done
  ...
  protected:
    ...
    vDataFile* mp_DataFile;                /*!< Pointer to the data file object in use */
    ...
    // Processing pre- and post-iteration loop
    bool m_needPreProcessLoop;             /*!< Flag specifying if the optimizer needs to perform a pre-processing loop (before iterations are done) */
