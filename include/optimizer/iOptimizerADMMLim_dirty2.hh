...
/*!
  \file
  \ingroup  optimizer
  \brief    Declaration of class iOptimizerADMMLim_dirty2
*/

#ifndef iOptimizerADMMLim_dirty2_HH
#define iOptimizerADMMLim_dirty2_HH 1
...
/*!
  \class   iOptimizerADMMLim_dirty2
...
*/
class iOptimizerADMMLim_dirty2 : public vOptimizer
{
  // -------------------------------------------------------------------
  // Constructor & Destructor
  public:
    /*!
      \fn      public iOptimizerADMMLim_dirty2::iOptimizerADMMLim_dirty2()
      \brief   The constructor of iOptimizerADMMLim_dirty2
    ...
    */
    iOptimizerADMMLim_dirty2();
    /*!
      \fn      public iOptimizerADMMLim_dirty2::~iOptimizerADMMLim_dirty2()
      \brief   The destructor of iOptimizerADMMLim_dirty2
  ...
  public:
    ...
    FUNCTION_OPTIMIZER(iOptimizerADMMLim_dirty2)
    /*!
      \fn      public int iOptimizerADMMLim_dirty2::ReadConfigurationFile()
    ...
    */
    ...
    /*!
      \fn      public int iOptimizerADMMLim_dirty2::ReadOptionsList()
    ...
    */
    ...
    /*!
      ...
      \details Inside the DataUpdateStep() of the oOptimizerManager, this is the second function called. This function is 
               overloaded ADMMLim_dirty2 optimizer to initialize u^k and v^k variables. 
    ...
    */
    virtual int DataStep4Optional( oProjectionLine* ap_Line, vEvent* ap_Event,
                                   ...
                                   int a_thread );
    /*!
      \fn      public virtual int iOptimizerADMMLim_dirty2::DataStep5ComputeCorrections()
      \param   oProjectionLine* ap_Line
      \param   vEvent* ap_Event
      \param   int a_bed
      \param   int a_timeFrame
    ...
    */
    virtual int DataStep5ComputeCorrections( oProjectionLine* ap_Line, vEvent* ap_Event,
                                             ...
                                             int a_thread );
    /*!
      \fn      public int iOptimizerADMMLim_dirty2::DataStep6Optional()
      \param   oProjectionLine* ap_Line
      \param   vEvent* ap_Event
      \param   int a_bed
      \param   int a_timeFrame
  ...
  private:
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty2::PreImageUpdateSpecificStep()
    ...
    */
    ...
    /*!
      \fn      private void iOptimizerADMMLim_dirty2::ShowHelpSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty2::CheckSpecificParameters()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty2::InitializeSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty2::SensitivitySpecificOperations()
      \param   FLTNB a_data
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty2::DataSpaceSpecificOperations()
      \param   FLTNB a_data
      \param   FLTNB a_forwardModel
    ...
    */
    int DataSpaceSpecificOperations( FLTNB a_data, FLTNB a_forwardModel, FLTNB* ap_backwardValues,
                                     ...
                                     FLTNB a_quantificationFactor, oProjectionLine* ap_Line);
    /*!
      \fn      private int iOptimizerADMMLim_dirty2::ImageSpaceSpecificOperations()
...
CLASS_OPTIMIZER(ADMMLim_dirty2,iOptimizerADMMLim_dirty2)
