...
/*!
  \file
  \ingroup  optimizer
  \brief    Declaration of class iOptimizerOneStepLate
*/

#ifndef IOPTIMIZERONESTEPLATE_HH
#define IOPTIMIZERONESTEPLATE_HH 1
...
*/
class iOptimizerOneStepLate : public vOptimizer
{
  // -------------------------------------------------------------------
  // Constructor & Destructor
  public:
    /*!
      \fn      public iOptimizerOneStepLate::iOptimizerOneStepLate()
      \brief   The constructor of iOptimizerOneStepLate
    ...
    */
    ...
    /*!
      \fn      public iOptimizerOneStepLate::~iOptimizerOneStepLate()
      \brief   The destructor of iOptimizerOneStepLate
  ...
  public:
    ...
    FUNCTION_OPTIMIZER(iOptimizerOneStepLate)
    /*!
      \fn      public int iOptimizerOneStepLate::ReadConfigurationFile()
    ...
    */
    ...
    /*!
      \fn      public int iOptimizerOneStepLate::ReadOptionsList()
      \param   const string& a_configurationFile
  ...
  private:
    ...
    /*!
      \fn      private int iOptimizerOneStepLate::PreImageUpdateSpecificStep()
  ...
  private:
    /*!
      \fn      private void iOptimizerOneStepLate::ShowHelpSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerOneStepLate::CheckSpecificParameters()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerOneStepLate::InitializeSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerOneStepLate::SensitivitySpecificOperations()
      \param   FLTNB a_data
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerOneStepLate::DataSpaceSpecificOperations()
      \param   FLTNB a_data
      \param   FLTNB a_forwardModel
    ...
    */
    int DataSpaceSpecificOperations( FLTNB a_data, FLTNB a_forwardModel, FLTNB* ap_backwardValues,
                                     ...
                                     FLTNB a_quantificationFactor, oProjectionLine* ap_Line );
    /*!
      \fn      private int iOptimizerOneStepLate::ImageSpaceSpecificOperations()
  ...
  private:
    ...
    bool  m_displayWarningFlag;                 /*!< Simple variable used to display the warning in ImageSpaceSpecificOperations about negative/null sensitivity+penalty term of OSL only once */
};
...
CLASS_OPTIMIZER(OSL,iOptimizerOneStepLate)
