...
class oOptimizerManager
{
  ...
  public:
    ...
    */
    ...
    /*!
      \fn      public inline void oOptimizerManager::SetDataFile()
    ...
    */
    /*!
      \fn      public inline void oOptimizerManager::EnterPreProcessLoop()
      \brief   Set pre-process flag of the vOptimizer to true
    */
    inline void EnterPreProcessLoop()
           {mp_Optimizer->EnterPreProcessLoop();}
    /*!
      \fn      public inline void oOptimizerManager::ExitPreProcessLoop()
      \brief   Set pre-process flag of the vOptimizer to false
    */
    ...
    */
    inline void EnterPostProcessLoop()
           {mp_Optimizer->EnterPostProcessLoop();}
    /*!
      \fn      public inline void oOptimizerManager::ExitPostProcessLoop()
      \brief   Set post-process flag of the vOptimizer to false
    */
    ...
    */
    inline bool NeedPreProcessLoop()
           {return mp_Optimizer->NeedPreProcessLoop();}
    /*!
      \fn      public inline bool oOptimizerManager::NeedPostProcessLoop()
      \brief   Say if the optimizer needs a post-process loop after iterations are done
      \return  m_needPostProcessLoop from the vOptimizer
    */
  ...
  private:
    ...
    vDataFile* mp_DataFile;                /*!< Pointer to the vDataFile object in use */
