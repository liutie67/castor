...
/*!
  \file
  \ingroup  optimizer
  \brief    Declaration of class iOptimizerADMMLim_dirty1
*/

#ifndef iOptimizerADMMLim_dirty1_HH
#define iOptimizerADMMLim_dirty1_HH 1
...
/*!
  \class   iOptimizerADMMLim_dirty1
...
*/
class iOptimizerADMMLim_dirty1 : public vOptimizer
{
  // -------------------------------------------------------------------
  // Constructor & Destructor
  public:
    /*!
      \fn      public iOptimizerADMMLim_dirty1::iOptimizerADMMLim_dirty1()
      \brief   The constructor of iOptimizerADMMLim_dirty1
    ...
    */
    iOptimizerADMMLim_dirty1();
    /*!
      \fn      public iOptimizerADMMLim_dirty1::~iOptimizerADMMLim_dirty1()
      \brief   The destructor of iOptimizerADMMLim_dirty1
  ...
  public:
    ...
    FUNCTION_OPTIMIZER(iOptimizerADMMLim_dirty1)
    /*!
      \fn      public int iOptimizerADMMLim_dirty1::ReadConfigurationFile()
    ...
    */
    ...
    /*!
      \fn      public int iOptimizerADMMLim_dirty1::ReadOptionsList()
    ...
    */
    ...
    /*!
      ...
      \details Inside the DataUpdateStep() of the oOptimizerManager, this is the second function called. This function is 
               overloaded ADMMLim_dirty1 optimizer to initialize u^k and v^k variables. 
    ...
    */
    virtual int DataStep4Optional( oProjectionLine* ap_Line, vEvent* ap_Event,
                                   ...
                                   int a_thread );
    /*!
      \fn      public virtual int iOptimizerADMMLim_dirty1::DataStep5ComputeCorrections()
      \param   oProjectionLine* ap_Line
      \param   vEvent* ap_Event
      \param   int a_bed
      \param   int a_timeFrame
    ...
    */
    virtual int DataStep5ComputeCorrections( oProjectionLine* ap_Line, vEvent* ap_Event,
                                             ...
                                             int a_thread );
    /*!
      \fn      public int iOptimizerADMMLim_dirty1::DataStep6Optional()
      \param   oProjectionLine* ap_Line
      \param   vEvent* ap_Event
      \param   int a_bed
      \param   int a_timeFrame
  ...
  private:
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty1::PreImageUpdateSpecificStep()
    ...
    */
    ...
    /*!
      \fn      private void iOptimizerADMMLim_dirty1::ShowHelpSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty1::CheckSpecificParameters()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty1::InitializeSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty1::SensitivitySpecificOperations()
      \param   FLTNB a_data
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerADMMLim_dirty1::DataSpaceSpecificOperations()
      \param   FLTNB a_data
      \param   FLTNB a_forwardModel
    ...
    */
    int DataSpaceSpecificOperations( FLTNB a_data, FLTNB a_forwardModel, FLTNB* ap_backwardValues,
                                     ...
                                     FLTNB a_quantificationFactor, oProjectionLine* ap_Line);
    /*!
      \fn      private int iOptimizerADMMLim_dirty1::ImageSpaceSpecificOperations()
...
CLASS_OPTIMIZER(ADMMLim_dirty1,iOptimizerADMMLim_dirty1)
