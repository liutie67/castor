...
/*!
  \file
  \ingroup  optimizer
  \brief    Declaration of class iOptimizerOPTITR
*/

#ifndef iOptimizerOPTITR_HH
#define iOptimizerOPTITR_HH 1
...
*/
class iOptimizerOPTITR : public vOptimizer
{
  // -------------------------------------------------------------------
  // Constructor & Destructor
  public:
    /*!
      \fn      public iOptimizerOPTITR::iOptimizerOPTITR()
      \brief   The constructor of iOptimizerOPTITR
    ...
    */
    ...
    /*!
      \fn      public iOptimizerOPTITR::~iOptimizerOPTITR()
      \brief   The destructor of iOptimizerOPTITR
  ...
  public:
    ...
    FUNCTION_OPTIMIZER(iOptimizerOPTITR)
    /*!
      \fn      public int iOptimizerOPTITR::ReadConfigurationFile()
    ...
    */
    ...
    /*!
      \fn      public int iOptimizerOPTITR::ReadOptionsList()
  ...
  private:
    ...
    */
    ...
    /*!
      \fn      private void iOptimizerOPTITR::ShowHelpSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerOPTITR::CheckSpecificParameters()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerOPTITR::InitializeSpecific()
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerOPTITR::SensitivitySpecificOperations()
      \param   FLTNB a_data
    ...
    */
    ...
    /*!
      \fn      private int iOptimizerOPTITR::DataSpaceSpecificOperations()
      \param   FLTNB a_data
      \param   FLTNB a_forwardModel
    ...
    */
    int DataSpaceSpecificOperations( FLTNB a_data, FLTNB a_forwardModel, FLTNB* ap_backwardValues,
                                     ...
                                     FLTNB a_quantificationFactor, oProjectionLine* ap_Line );
    /*!
      \fn      private int iOptimizerOPTITR::ImageSpaceSpecificOperations()
...
CLASS_OPTIMIZER(OPTITR,iOptimizerOPTITR)
