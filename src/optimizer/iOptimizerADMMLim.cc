...
/*!
  \file
  \ingroup  optimizer
  \brief    Implementation of class iOptimizerADMMLim
*/
...
iOptimizerADMMLim::iOptimizerADMMLim() : vOptimizer()
{
  // ---------------------------
...
int iOptimizerADMMLim::ImageSpaceSpecificOperations( FLTNB a_currentImageValue, FLTNB* ap_newImageValue,
